...
export type InfrastructureObservation = { domain?: string; ip?: string; asn?: string; asn_org?: string; isp?: string; country?: string; region?: string; city?: string; latitude?: number; longitude?: number; timezone?: string; vpn?: boolean; tor?: boolean; proxy?: boolean; source?: string; status?: string; enrichment_status?: string; geoip_status?: string };
